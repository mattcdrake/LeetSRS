...
Brought forward from the saved-input recovery decision in [PR #346](https://github.com/mattcdrake/LeetSRS/pull/346). The current work is tracked under [#348](https://github.com/mattcdrake/LeetSRS/issues/348): historical contracts and typed persistence in [#349](https://github.com/mattcdrake/LeetSRS/issues/349), raw backup migration in [#350](https://github.com/mattcdrake/LeetSRS/issues/350), and startup recovery in [#352](https://github.com/mattcdrake/LeetSRS/issues/352). Earlier PR code is not the implementation base.
