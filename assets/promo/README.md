...
| [GitHub social preview](social/github-preview.png) | 1280 × 640 |
...
The README install button displays at 292 × 52 pixels and links to the Chrome Web Store. Its [SVG source](add-to-chrome.svg) reuses the website's Chrome outline icon and outlined Geist typography; the 2× PNG stays sharp on high-density displays.
