import { z } from 'zod';
import { legacyNoteSchema, noteTextSchema } from '@/background/legacy/document-conversions/001-add-card-domain';
import { outputSchema as inputSchema } from '@/background/legacy/document-conversions/003-remove-day-start';
