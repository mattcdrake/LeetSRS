...
- [x] Add an immediate state-cleanup path when `prefers-reduced-motion: reduce` applies, because `animation: none` does not emit `animationend`.
- [x] Add global reduced-motion CSS that disables nonessential animations and transitions.
