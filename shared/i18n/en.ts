...
const en = {
  ...
  roadmaps: {
    ...
    activateRoadmap: 'Activate roadmap',
    deactivateRoadmap: 'Deactivate roadmap',
    activationLabel: (name: string) => `Activate ${name}`,
    deactivationLabel: (name: string) => `Deactivate ${name}`,
