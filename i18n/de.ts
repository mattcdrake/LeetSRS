...
const de: Translations = {
  ...
  applicationErrors: {
    ...
    invalid_input: 'Prüfe deine Eingabe und versuche es erneut.',
    invalid_settings: 'Prüfe deine Einstellungen und versuche es erneut.',
    card_not_found: 'Diese Karte existiert nicht mehr. Aktualisiere die Ansicht und versuche es erneut.',
    invalid_backup: 'Wähle eine gültige LeetSRS-Sicherungsdatei.',
    gist_token_required: 'Gib ein persönliches GitHub-Zugriffstoken ein.',
    gist_id_required: 'Gib eine Gist-ID ein.',
    gist_not_found: 'Gist nicht gefunden. Prüfe die ID und deine Zugriffsrechte.',
    gist_backup_missing: 'Dieser Gist enthält keine LeetSRS-Sicherung.',
    github_unauthorized: 'GitHub hat das Token abgelehnt. Prüfe oder ersetze es.',
    github_forbidden: 'GitHub hat den Zugriff verweigert. Prüfe die Token-Berechtigungen und den Gist-Zugriff.',
    github_rate_limited: 'GitHub-Anfragelimit erreicht. Versuche es später erneut.',
    github_unavailable: 'GitHub ist vorübergehend nicht verfügbar. Versuche es später erneut.',
    note_too_long: 'Deine Notiz darf höchstens {limit} Zeichen enthalten.',
    unsupported_backup_version:
      'Sicherungsversion {version} erfordert eine neuere LeetSRS-Version. Aktualisiere die Erweiterung und versuche es erneut.',
  },
  errors: {
