...
<!-- Adapted from https://github.com/getsentry/skills/tree/main/skills/agents-md.
Local changes: omit upstream maintenance docs and mandatory commit attribution;
preserve the repository's CLAUDE.md convention. See LICENSE. -->
...
- Preserve the repository's existing `CLAUDE.md` convention; in this repo it contains only `AGENTS.md`.
